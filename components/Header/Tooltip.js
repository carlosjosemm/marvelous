...
const StyledTooltipContent = styled.span`
    ...
    border-radius: 4px;
    font-size: 1rem;
    transition: display 0.3s, background-color 0.3s, width 0.3s, padding 0.3s ease-in-out;
    &:before {
      content: "";
      width: 0;
      height: 0;
      ...
      ${props => props.$position == 'bottom' ? 'transform: rotate(135deg);' : 'transform: rotate(45deg);'}
